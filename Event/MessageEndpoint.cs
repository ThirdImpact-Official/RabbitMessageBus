...
namespace Event
{
    public class MessagesBusEndpoint 
    {
        private readonly IRabbitMQAdapter rabbitMqAdapter;
        private readonly IReflexionUtil reflectionUtil = new ReflexionUtil();

        public MessagesBusEndpoint(IRabbitMQAdapter rabbitMQadapter)
        {
